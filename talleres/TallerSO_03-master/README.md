...
```
curl -L -o master.zip https://github.com/jfcmacro/TallerSO_03/archive/refs/heads/master.zip
unzip master.zip
rm master.zip
```
...
**c Abrir una terminal. Ir a la carpeta (directorio) que contiene el taller actual, y buscar el directorio nombrado `bash_01`.
